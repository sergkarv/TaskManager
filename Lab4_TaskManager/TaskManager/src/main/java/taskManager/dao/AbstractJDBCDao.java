...
public abstract class AbstractJDBCDao<T extends Identified<PK>, PK extends Integer> implements GenericDao<T, PK> {
    ...
    /**
     * Возвращает sql запрос для вставки новой записи в базу данных.
     * Ручной ввод id из объекта T
     *
     */

    public abstract String getCreateQueryForImport();
    ...
    protected abstract String last_insert_id();

    protected abstract String last_insert_table();
